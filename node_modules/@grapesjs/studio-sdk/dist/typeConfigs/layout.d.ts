...
import { StudioColumnConfigProps, StudioComponentsConfigProps, StudioRowConfigProps } from '../components/public/utils';
import { CSSProperties } from 'react';
import { StudioIconProps } from '../components/public/StudioIcon';
export type { CustomLayoutComponent } from '../components/public/utils';
export type RootLayoutConfig = StudioRowConfigProps | StudioColumnConfigProps;
...
export interface LayoutPlacerPopover {
...
export interface LayoutCommandProps {
    id: string;
    layout: StudioComponentsConfigProps['type'] | StudioComponentsConfigProps;
